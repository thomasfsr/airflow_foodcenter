...
import Revenue_by_Segments, Revenue_by_States, Top_20_drivers
...
class MultiApp:
    ...
    def run():
        with st.sidebar:        
            app = option_menu(
                menu_title='Reports',
                options=['Top 20 Drivers','Revenue by Segments', 'Revenue by States'],
                icons=['trophy-fill','bar-chart-line-fill','bar-chart-line-fill',],
